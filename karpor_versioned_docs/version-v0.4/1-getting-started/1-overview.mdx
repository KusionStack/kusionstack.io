        ...
        >
          <div style={{ width: "100%" }}>
            ...
            <div style={{ padding: "5px 0px" }}>
                Karpor is <b>Intelligence for Kubernetes</b>. It
                brings advanced <b>🔍 Search, 💡 Insight and ✨ AI</b> to Kubernetes. It is essentially
                a <b>Kubernetes Explorer</b>/<b>Kubernetes Dashboard</b>. 
                With Karpor, you can gain crucial visibility into your Kubernetes clusters 
                across any clouds and empower developers to ship faster.
            </div>
            <div style={{ padding: "5px 0px" }}>
                We hope to become a <b>small and beautiful, vendor-neutral,
                developer-friendly, community-driven</b> project! 🚀
            </div>
          </div>
