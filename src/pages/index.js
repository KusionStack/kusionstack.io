                    ...
                    <div className="container text--center">
                        ...
                        >
                            <Translate id="home.quickstart">
                                All About Your Modern Apps by Platform
                                Engineering
                            </Translate>
                        </h2>
                    </div>
                                ...
                                <>
                                    <p>
                                        <Translate id="home.easyshipping.1">
                                            Manage all application operations in
                                            one place, in a unified easy way
                                        </Translate>
                                    </p>
                                    <ul className="left-align-ul">
                                        <li>
                                            <Translate id="home.easyshipping.2">
                                                Environment-agnostic application
                                                configurations
                                            </Translate>
                                        </li>
                                        <li>
                                ...
                                <>
                                    <p>
                                        <Translate id="home.platformengineering.1">
                                            Fulfill the customized needs with
                                    ...
                                    <ul className="left-align-ul">
                                        <li>
                                            <Translate id="home.platformengineering.2">
                                                A growing open module ecosystem
                                        ...
                                        <li>
                                            <Translate id="home.platformengineering.3">
                                                ...
                                                paradigm between App Developers
                                                and Platform Engineers
                                            </Translate>
                                        </li>
                                        <li>
                                            <Translate id="home.platformengineering.4">
                                                Building the golden path for
                                ...
                                <>
                                    <p>
                                        <Translate id="home.enterpriseops.1">
                                            From the first line of codes to
                                            production runtime
                                        </Translate>
                                    </p>
                                    <ul className="left-align-ul">
                                        <li>
                                            <Translate id="home.enterpriseops.2">
                                                Codified shift-left validation
                                                to detect configuration risks
                                            </Translate>
                                        </li>
                                        <li>
                                            <Translate id="home.enterpriseops.3">
                                                Extended check stages for
                                                workload lifecycle
                                            </Translate>
                                        </li>
                                        <li>
                                            <Translate id="home.enterpriseops.4">
                                                ...
                                                cluster control for Kubernetes
                                            </Translate>
                                        </li>
                                    </ul>
                                </>
