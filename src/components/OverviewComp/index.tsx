        ...
        >
            <div className={styles.feature_desc}>
                ...
                <div className={styles.desc}>
                    But the modern day for most software organizations this
                    promise quickly become unrelalistic since the increasingly
                    complex cloud-native toolchains, while cloud native
                    technologies made huge improvements in areas such as
                    scalability, availability and operability, it also brings
                    downside - the growing burden on developers, which leads to
        ...
        <>
            <div className={styles.top_content}>
                ...
                <div className={styles.title}>
                    Limitless Insights 📊. With AI. ✨
                </div>
                {/* <div className={styles.sub_title}> With AI. ✨</div> */}
                <div className={styles.desc}>
                    A Multi-Cluster Kubernetes Data Plane focusing on Search,
